...
print(f"El área de un {triangulo.get_identificador()} de base {base} y altura {altura} es : {triangulo.get_area(base,altura)} \
      y el perímetro es {triangulo.get_perimetro(base,base,base)}")
print(rectangulo.get_identificador())
print(f"El área del {rectangulo.get_identificador()} de base {base} y altura {altura} es: {rectangulo.get_area(base,altura)} \
        y el perímetro es {rectangulo.get_perimetro(base,altura)} ")

radio=2
print(f"El área de una circunferencia de radio {radio} es {circunferencia.get_area(radio)} u**2") 